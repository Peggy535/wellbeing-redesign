...
<section class="absolute top-0 z-20 w-screen overflow-x-hidden overscroll-none text-rose-4">
  ...
  <div class="grid h-screen grid-cols-2 grid-rows-2 sm:grid-cols-4">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-2 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 place-items-start">
      <p class="text-lg leading-relaxed lg:text-xl text-zinc-800"><span class="font-Eiko-Italic text-rose-4 text-7xl lg:text-9xl">Hello</span> and welcome to my website, I hope you find both it and the words helpful, healing and inspiring. Whatever you are facing at this time 
  ...
  <div class="grid grid-cols-2 grid-rows-2 sm:grid-cols-4">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-2 sm:row-span-1 place-content-evenly lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2">
      <p class=" text-lg leading-relaxed lg:text-xl text-zinc-800"><span class="font-Eiko-Italic text-rose-4 text-8xl lg:text-9xl">By</span> now hopefully, you've pressed the play button on my welcome message above. 
      ...
      <p class=" text-lg leading-relaxed lg:text-xl text-zinc-800">Just as so many before me and many to follow, I've had my own path to travel and it's not always been straight 
  ...
  <div class="grid h-fit grid-cols-1 sm:grid-cols-4">
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-2 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 items-start">
      <p class=" text-lg leading-relaxed lg:text-xl text-zinc-800"><span class="font-Eiko-Italic text-rose-4 text-7xl lg:text-9xl">My</span>desire today and every day hereon, is to make people feel less broken, so they 
