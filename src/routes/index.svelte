...
<section class="z-20 w-screen overflow-x-hidden overscroll-none">
  <div class="grid h-screen w-screen grid-rows-4 grid-cols-1">
    <div class="grid row-start-3 row-end-4 items-end">
      <h1 class="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-11xl pl-3 sm:pl-3 md:pl-4 lg:pl-6 2xl:pl-10">JH Online Therapies</h1>
    </div>
  </div>
</section>
<section class="z-30 w-screen">
  <div class="grid h-screen grid-cols-2 grid-rows-2 sm:grid-cols-4">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2">
      <p class="text-xl sm:text-2xl md:text-3xl lg:text-lg leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed">Hello and welcome to my website, I hope you find both it and the words helpful, healing and inspiring. Whatever you are facing at this time 
