...
<Sketch1/>
<section class="z-20 w-screen overflow-x-hidden overscroll-none">
...
<section class="z-30 w-screen">
  <div class="grid h-screen grid-cols-2 grid-rows-2 sm:grid-cols-4">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2">
      <p class="text-xl sm:text-2xl md:text-3xl lg:text-2xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed"><span class="text-6xl lg:text-7xl">Hello</span> and welcome to my website, I hope you find both it and the words helpful, healing and inspiring. Whatever you are facing at this time 
  ...
  <div class="grid grid-cols-2 grid-rows-2 sm:grid-cols-4">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-3 sm:row-span-1 place-content-evenly lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2">
      <p class="text-lg lg:text-2xl leading-relaxed ">By now hopefully, you’ve pressed the play button on both my welcome and about me recordings and I’ve saved you valuable time on reading a 
      ...
      <p class="text-lg lg:text-2xl leading-relaxed">At this stage you would have heard my story and know, just as so many before me and many to follow, I’ve had my own path to travel and it’s not always been straight 
  ...
  <div class="grid grid-cols-2 grid-rows-2 sm:grid-cols-4 place-content-evenly">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2">
      <p class="text-lg lg:text-2xl">My desire today and every day hereon, is to make people feel less broken, so they can experience more joy and happiness and less stress in their lives. 
