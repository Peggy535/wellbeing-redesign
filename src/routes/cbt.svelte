<section class="absolute z-20 top-0 w-screen overflow-x-hidden text-rose-main">
  <div class="grid h-screen w-screen grid-rows-4 grid-cols-1">
    <div class="grid row-start-3 row-end-4 items-end">
      <h1 class="font-Eiko-Thin text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-12xl 2xl:text-14xl pl-3 sm:pl-3 md:pl-4 lg:pl-6 2xl:pl-10">Mindful CBT</h1>
      <p class="text-stone-700 text-sm pl-3 sm:pl-3 md:pl-4 lg:pl-6 2xl:pl-10">(Cognitive Behavioural Therapy)</p>
    </div>
  </div>
  <div class="grid h-screen grid-cols-1 sm:grid-cols-4">
    <div class="grid col-span-1 sm:col-start-2 sm:col-end-5 lg:col-start-2 items-center m-1 p-1">
      <h2 class="text-5xl pr-2 sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-7xl text-right font-Eiko-Italic md:pr-4 lg:pr-6 2xl:pr-8">
