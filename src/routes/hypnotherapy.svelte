...
<section class="absolute z-20 top-0 w-screen m-0 p-0">
  ...
  <div class="grid grid-cols-1 grid-rows-1 sm:grid-cols-4">
    <div class="grid h-fit col-span-1 row-span-1 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 items-end sm:items-center 2xl:place-content-end">
      <p class="text-lg sm:text-xl md:text2xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-loose"><span class="text-5xl md:text-6xl lg:text-6xl">Curative</span> hypnotherapy is a more 
  ...
  <div class="grid h-screen grid-cols-1 grid-rows-1 lg:grid-cols-5">
    <div class="grid col-span-1 row-span-1 lg:col-start-2 lg:col-end-6 place-items-center">
      <h2 class="text-4xl m-1 p-1 sm:text-6xl sm:mb-20 md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-7xl text-right font-Eiko-Italic 2xl:leading-snug md:pr-4 lg:pr-6 2xl:pr-8">
  ...
  <div class="grid grid-cols-1 grid-rows-1 sm:grid-cols-4">
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 place-items-center 2xl:hidden">
      <p class="text-lg sm:text-xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-loose"><span class="text-5xl md:text-6xl lg:text-7xl">You are</span> not asleep, but it is something 
  ...
  <div class="grid h-screen grid-cols-2 grid-rows-2 sm:grid-cols-4">
    <div class="grid col-start-1 col-end-3 row-start-1 row-end-2 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 place-items-center">
    ...
    <div class="grid col-start-1 col-end-3 row-start-2 row-end-3 sm:col-span-4 sm:row-span-1 items-start">
      <h2 class="text-4xl m-1 p-1 sm:text-6xl md:text-6xl lg:text-7xl xl:text-7xl 2xl:text-8xl text-right font-Eiko-Italic md:p-4 lg:p-6 2xl:p-8">
  ...
  <div class="grid grid-cols-1 grid-rows-1 sm:grid-cols-4">
    <div class="grid h-fit col-span-1 row-span-1 sm:col-span-3 sm:row-span-1 lg:col-span-2 m-1 p-1 lg:m-2 lg:p-2 items-end sm:items-center 2xl:place-content-end">
      <h2 class="pb-10 font-Eiko-Italic text-4xl">A useful tip...</h2><br>
      <p class="text-lg sm:text-xl md:text2xl leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-loose"><span class="text-5xl md:text-6xl lg:text-6xl">Many</span>people 
